...
export const LabourPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="text-sm font-semibold text-gray-900">Labour Expense</h2>
        <p className="text-xs text-gray-400 mt-0.5">Log labour expense entries</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5">
          <LabourForm onSuccess={() => setRefreshKey(k => k + 1)} />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5">
          <LabourTable refreshKey={refreshKey} />
        </div>
      </div>
    </div>
  );
