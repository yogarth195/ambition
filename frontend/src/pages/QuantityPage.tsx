...
import { QuantityTable } from '@/components/tables/QuantityTable';

export const QuantityPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-0.5">Log EVA quantity entries</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5">
          <QuantityForm onSuccess={() => setRefreshKey(k => k + 1)} />
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5">
          <QuantityTable refreshKey={refreshKey} />
        </div>
      </div>
    </div>
  );
